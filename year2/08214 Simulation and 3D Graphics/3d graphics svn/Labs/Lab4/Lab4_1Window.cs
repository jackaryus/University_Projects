...
namespace Labs.Lab4
{
    public class Lab4_1Window : GameWindow
    {
        ...
        private Vector3 mCirclePosition, mCircleVelocity, mPrevCirclePosition;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            mCircleVelocity = new Vector3(0.4f, 0.5f, 0);
        ...
        { 
            ...
            mPrevCirclePosition = mCirclePosition;
            ...
            {
                mCirclePosition = mPrevCirclePosition;
            ...
            if (circleInSquareSpace.Y + (mCircleRadius / mSquareMatrix.ExtractScale().Y) > 1)
            {
                ...
                normal = Vector3.Transform(new Vector3(0, -1, 0), mSquareMatrix.ExtractRotation());
                mCircleVelocity = mCircleVelocity - 2 * Vector3.Dot(normal, mCircleVelocity) * normal;
                //mCircleVelocity.Y = -mCircleVelocity.Y;
            }
            if (circleInSquareSpace.Y - (mCircleRadius / mSquareMatrix.ExtractScale().Y) < -1)
